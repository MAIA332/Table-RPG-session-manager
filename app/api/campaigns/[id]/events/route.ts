...
export async function POST(
  ...
  // Propaga as ações de Ameaças Ambientais / Hazards
  else if (body.action === "hazard:launch") {
    publish(id, { type: "hazard:launch", hazard: body.hazard })
  } else if (body.action === "hazard:stop") {
    publish(id, { type: "hazard:stop", hazardType: body.hazardType })
  }
